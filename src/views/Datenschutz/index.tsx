...
const Datenschutz = (): JSX.Element => {
  ...
  return (
    <DatenschutzWrapper>
      ...
      4665 Oftringen<br />
      Switzerland<br />
      Email: inof@resinart-coachin.ch<br />
      <br /><br />
      Persons<br />
      Marcello Pierri,<br />
      Sylvie Pierri<br />
      <br /><br />
      Company Name: Resin Art & Coaching GmbH
      <br /><br />
      General<br />
      ...
      <br /><br />
      Agency services
      We process the data of our customers in accordance with the data protection provisions of the Federal (Data Protection Act, DSG) and the EU-DSGVO in the context of our contractual services.
